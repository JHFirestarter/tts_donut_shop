...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { bread: @donut.bread, cost: @donut.cost, image: @donut.image, name: @donut.name, toppings: @donut.toppings }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { bread: @donut.bread, cost: @donut.cost, image: @donut.image, name: @donut.name, toppings: @donut.toppings }
    assert_redirected_to donut_path(assigns(:donut))
  end
